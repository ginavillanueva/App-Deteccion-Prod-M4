...
class CriticalProductCase:
    ...
    def __post_init__(self) -> None:
        ...
        validate_human_note_is_safe(self.evidence_photo_name)
        ...
        self.events.append(
            DomainEvent(
                ...
                payload={
                    ...
                    "evidence_photo_present": bool(self.evidence_photo_data),
                    "evidence_photo_name": self.evidence_photo_name,
                },
            )
        )
    ...
    def validate_by_supervisor(self, supervisor_user: str, decision: str = "APROBADO", comment: str = "") -> None:
        self._required("supervisor_user", supervisor_user)
        validate_human_note_is_safe(comment)
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "evidence_photo_name": self.evidence_photo_name,
            "evidence_photo_data": self.evidence_photo_data,
            "evidence_photo_present": bool(self.evidence_photo_data),
