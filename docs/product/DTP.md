...
|---|---|---|---|---|---|
| 24/06/2026 | Implementación de vertical slice: registro de producto próximo a vencer, acción comercial, cambio de precio, scoring, eventos, validación de supervisor y dashboard | FSD-UC-001 / DD-UC-001 | ADR-0006 | PR-IMPL-001 | estudiante responsable |
